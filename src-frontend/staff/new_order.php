...
<body onload="auth()">
    ...
    <div class="container">
        ...
        <div class="bodyLeft" style="float:left;">
            ...
            <a type="button" href="/staff/checkout.php" class="btn btn-light btn-primary btn-lg btn-outline-dark" style="margin-left: 45px; width: 60%">
                Close Order
            </a>

            <a type="button" href="/staff/index.php" class="btn btn-danger btn-primary btn-lg" style="margin-left: 20px; width: 28%">
                Cancel Order
            </a>
        </div>
        <!--End of Left Body-->
