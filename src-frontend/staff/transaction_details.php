...
<head>
    ...
    <?php include("/componenets/bootsrap.php"); ?>
</head>
...
<body>
    ...
    <div class="bodyRight" style="float:right;">
        ...
        <!--Subtotal table-->
        <button type="button" class="btn btn-light btn-primary btn-lg btn-outline-dark" style="margin-left: 220px; margin-top: 110px; width: 60%">
            Done
        </button>
    </div>
    <!--End of Right Body-->
