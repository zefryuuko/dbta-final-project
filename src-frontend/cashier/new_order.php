...
<body>
    <div class="container">
        ...
        <div class="bodyLeft" style="float:left;">
            ...
            <a type="button" href="/cashier/checkout.php" class="btn btn-light btn-primary btn-lg btn-outline-dark" style="margin-left: 55px; width: 60%">
                Close Order
            </a>

            <a type="button" href="/cashier/index.php" class="btn btn-danger btn-primary btn-lg" style="margin-left: 30px; width: 27.2%">
                Cancel Order
            </a>
        </div>
        <!--End of Left Body-->
